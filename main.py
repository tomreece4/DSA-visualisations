...
if __name__ == "__main__":
    ...
    def run():
        ...
        if algo == "Bubble Sort":
            sorting_algorithms.bubble_sort(param)
        elif algo == "Selection Sort":
            sorting_algorithms.selection_sort(param)
        elif algo == "Insertion Sort":
            sorting_algorithms.insertion_sort(param)
        elif algo == "Quick Sort":
            sorting_algorithms.quick_sort(param)
        elif algo == "Merge Sort":
            sorting_algorithms.merge_sort(param)
        elif algo == "Depth-First Search":
            traversal_algorithms.dfs_visualize(param)
        elif algo == "Breadth-First Search":
            traversal_algorithms.bfs_visualize(param)
    ...
    run_button.grid(column=0, row=2, columnspan=2, pady=5)
